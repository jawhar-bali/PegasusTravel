...
//              
    ...
    public List<Reclamation> afficherReclamation() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                testajout = new Reclamation(rs.getString("nom"), rs.getString("prenom"), rs.getString("email"), rs.getString("Commentaire"), rs.getDate("dateReclamation"), rs.getString("typeReclamation"), rs.getInt("id_user"));
                liste.add(testajout);
            }
